...
for i in range(10):
    ...
    ClassifierMetrics.conf_matrix(SVC_vit.y_test, y_pred_vit_classif, class_names=["Non-Responder", "Responder"], title=f"Confusion Matrix for speed classification (random state:{SVC_vit.random_state})", output_path=output_path, rdm_state=SVC_vit.random_state)
